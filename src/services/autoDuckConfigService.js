...
export const AUTODUCK_CONFIG_SCHEMA = {
    ...
    AUTODUCK_IDLE_FAST_SCAN_MS: {
        ...
        default: 180000,
        group: 'idle',
        label: 'Tham chiếu nhịp idle (ms) — không còn timer riêng',
        help: 'Trước đây là timer IDLE 3 phút (gây skip lock). Nay quét entry chỉ còn 1 hàng đợi theo SCAN_GAP; nới điểm idle gắn vào cùng vòng quét đó. Giá trị này giữ để tương thích UI / tham chiếu — cadence thực tế = SCAN_GAP(_LIVE).',
        example: 'Mặc định: 180000. Đổi SCAN_GAP_MS / SCAN_GAP_LIVE_MS để chỉnh nhịp quét.',
        note: 'Thiếu lệnh: nới điểm trên vòng quét chính (IDLE_FAST), không gõ cửa riêng mỗi 3 phút.',
        hintKind: 'default',
    },
