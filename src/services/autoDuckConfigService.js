...
export const AUTODUCK_CONFIG_SCHEMA = {
    ...
    AUTODUCK_LIVE_MIN_QUALITY_VWAP_RECLAIM: {
        ...
        help: '0 = lấy mức an toàn mặc định 90 (hoặc mức chung nếu cao hơn). Tăng = siết thêm. Chỉ giảm khi đã có dữ liệu testnet chứng minh setup này có expectancy dương.',
        example: 'Mặc định: 0 (= tối thiểu 90). Có thể đặt 92 để chọn lọc hơn.',
        note: 'LIVE VWAP reclaim còn yêu cầu nến đóng trên VWAP, có dấu hiệu reclaim/retest và volume >= 1.6x; tránh nhầm giá đi ngang sát VWAP là setup mạnh.',
        badge: 'live',
        hintKind: 'default',
    },
