...
export const AUTODUCK_CONFIG_SCHEMA = {
    ...
    AUTODUCK_IDLE_LIVE_DAILY_TARGET: {
        ...
        help: 'Khi số lệnh LIVE mở trong ngày thấp hơn mục tiêu, bật idle-hunger (ưu tiên xếp hạng + size nhỏ + nới sàn tối đa −2 trong band).',
        example: 'Mặc định: 5. Tăng 7–8 nếu muốn nhiều mẫu hơn; giảm 3 nếu muốn ít lệnh hơn.',
        note: 'Không hạ quality/edge tĩnh toàn cục — chỉ nới trong band tuyệt đối.',
        badge: 'live',
        hintKind: 'default',
    },
    AUTODUCK_IDLE_LIVE_SIZE_MULT: {
        type: 'number',
        default: 0.45,
        group: 'idle',
        label: 'Hệ số size khi LIVE idle-hunger',
        help: 'Khi đói lệnh LIVE, nhân size (0.45 = 45%) trước khi nới sàn điểm.',
        example: 'Mặc định: 0.45. 0.3 = thăm dò nhỏ; 0.6 = gần lệnh thường.',
        note: '',
        badge: 'live',
        hintKind: 'default',
    },
    AUTODUCK_IDLE_LIVE_FLOOR_RELAX: {
        type: 'number',
        default: 2,
        group: 'idle',
        label: 'Nới sàn quality LIVE tối đa khi đói lệnh',
        help: 'Chỉ áp sau N chu kỳ vẫn thiếu lệnh. Không bao giờ thủng AUTODUCK_QUALITY_FLOOR_ABS.',
        example: 'Mặc định: 2. Không nên > 2.',
        note: '',
        badge: 'live',
        hintKind: 'default',
    },
