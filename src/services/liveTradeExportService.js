...
export const exportLiveTradeStats = async ({ outputDir, fileNamePattern, dateFrom, dateTo } = {}) => {
    ...
    const tradeRows = autoLive
        .map((t) => {
            ...
            return {
                ...
                markSimPnl: t.markSimPnl ?? '',
                markSimPnlPercent: t.markSimPnlPercent ?? '',
                markSimExitPrice: t.markSimExitPrice ?? '',
    ...
    const tradesColumns = [
        ...
        { label: 'pnlSource', get: (r) => r.pnlSource },
        { label: 'markSimPnl_VND', get: (r) => r.markSimPnl },
        { label: 'markSimPnlPercent', get: (r) => r.markSimPnlPercent },
        { label: 'markSimExitPrice', get: (r) => r.markSimExitPrice },
