...
router.get('/set-commands', async (req, res) => {
    try {
        ...
        const commands = [
            { command: 'start',     description: 'Bat auto-trade pipeline' },
            { command: 'stop',      description: 'Tat auto-trade pipeline' },
            { command: 'status',    description: 'Dashboard tong quan he thong' },
            { command: 'live',      description: 'Xem lenh LIVE dang mo + thong ke 30 ngay' },
            { command: 'sim',       description: 'Xem lenh SIM dang chay + thong ke 30 ngay' },
            { command: 'pnl',       description: 'PnL hom nay (LIVE + SIM + Manual)' },
            { command: 'portfolio', description: 'Danh sach goi portfolio dang chay' },
            { command: 'market',    description: 'Tong quan thi truong VN + Crypto' },
            { command: 'stats',     description: 'Thong ke giao dich (mac dinh 30 ngay)' },
            { command: 'info',      description: 'Gia + ky thuat mot ma. VD: /info MBB' },
            { command: 'insight',   description: 'Bao cao AI thi truong hom nay' },
            { command: 'funnel',    description: 'Funnel scan cuoi. VD: /funnel crypto' },
            { command: 'health',    description: 'Trang thai he thong & tai nguyen' },
            { command: 'broker',    description: 'Ket noi san giao dich' },
            { command: 'manual',    description: 'Danh sach lenh manual dang mo' },
            { command: 'ai',        description: 'Bai hoc AI + thong ke hanh vi gan day' },
            { command: 'settings',  description: 'Xem cau hinh auto-trade hien tai' },
